...
## V. 2.3 - Intermediari e Diretto e Studio Associato - fatture messe a disposizione
...
print('Sintassi:')
print('py fec_ricevutedisposizione.py UTENZA_ENTRATEL pin_entratel password_entratel cfstudio Data_inizio Data_fine cf_cliente piva_cliente')
print('DEVI essere amministratore ed aver settato il tuo profilo!')
time.sleep(5)
s = requests.Session()
...
path = r'FattureRicevuteDisposizione_' + cfcliente
...
os.system('cls')
print('Totale fatture messe a disposizione scaricate: ', numero_fatture)
print('Totale notifiche fatture messe a disposizione scaricate: ', numero_notifiche)
sys.exit()